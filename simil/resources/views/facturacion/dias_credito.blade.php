...
<div style="margin:1%;" class="d-sm-flex align-items-center justify-content-between mb-4" id="div_encabezado_dias_credito" name="div_encabezado_dias_credito">
    <h1 class="h3 mb-0 text-gray-800">
        Modulo De Dias De Credito
    </h1>
    <a href="#" onclick="openModal();" style="background-color: #1cc88a; color: white;" class="d-none d-sm-inline-block btn btn-sm shadow-sm">
        <i class="fas fa-plus-circle fa-sm text-white-50"></i> Agregar Dias Credito
    </a>
</div>

<div style=" background-color: #f3b103; width: 90%; margin: 0 auto;">
    <label style="color: white; margin: 1%;">Listado De Dias De Credito</label>
</div>

<div style="margin:2%;"></div>

<div id="div_listado_dias_credito" name="div_listado_dias_credito" style="width: 90%; margin: 0 auto;">
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div style="background-color: #4e73df; color: white; width: 100%; margin: 0 auto;">
            <label style="color: white; margin: 1%;">Agregar Dias De Credito</label>
            <label onclick="closeModal()" style="color: white; float: right; margin: 1%;"  >X</label>
        </div>
    
        <table style="width:60%; margin: 0 auto;">
            <tr>
                <td style="width:50%">Codigo Dias Credito:</td>
                <td style="width:50%">
            ...
            <tr>
                <td style="width:50%">Dias Credito: </td>
                <td style="width:50%">
                    <input type="text" style="width: 50%;" class="form-control bg-light border-0 small" placeholder="60"
